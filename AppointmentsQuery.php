...
<!--Query Result-->
    <div class = 'treatmentOptions'>
        <div class = 'option1'>
           <div class = optionTitle> Appointments</div>
               <div class = optionBody>
                <center>
                <?php
                    ...
                    $sql = "SELECT Date, doctor_Name, Room_num
                            FROM APPOINTMENT
                            WHERE APPOINTMENT.Patient_ssn =  '".$ssn."';";

                    $result = mysqli_query($conn,$sql);
                    print "<pre>";
                    print "<table border=1>";
                    print "<tr><td>Date</td><td> Doctor </td><td>Room Number</td>";
                    while($row = mysqli_fetch_array($result, MYSQLI_BOTH))
                    {
                        print "\n";
                        print "<tr><td>$row[Date] </td><td> $row[doctor_Name]  </td><td> $row[Room_num]  </td></tr>    ";
                    }
                    print "</table>";
                    print "</pre>";

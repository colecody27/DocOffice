...
<!--Query Result-->
    <div class = 'treatmentOptions'>
        <div class = 'option1'>
           <div class = optionTitle> Patient Information</div>
               <div class = optionBody>
                <center>
                <?php
                    ...
                    $sql = "SELECT First_name, Last_name, City, Zip_code, Insurance_ID
                            FROM PATIENT
                            WHERE ssn =   '".$ssn."';";
                    ...
                    print "<tr><td>First Name</td><td>Last name</td><td>City</td><td>Zip</td><td> Insurance ID </td>";
                    while($row = mysqli_fetch_array($result, MYSQLI_BOTH))
                    {
                        print "\n";
                        print "<tr><td>$row[First_name] </td><td>$row[Last_name] </td><td>$row[City] </td><td>$row[Zip_code] </td><td> $row[Insurance_ID]  </td></tr>    ";
                    }
                    print "</table>";
                    print "</pre>";

...
<!--Query Result-->
    <div class = 'treatmentOptions'>
        <div class = 'option1'>
           <div class = optionTitle> Prescriptions</div>
               <div class = optionBody>
                <center>
                <?php
                    ...
                    $sql = "SELECT PRESCRIPTION.Drug_name, PRESCRIPTION.Dosage
                            FROM PRESCRIPTION
                            WHERE PRESCRIPTION.Patient_ssn = '".$ssn."';";

                    $result = mysqli_query($conn,$sql);
                    print "<pre>";
                    print "<table border=1>";
                    print "<tr><td>Drug Name</td><td> Dosage </td>";
                    while($row = mysqli_fetch_array($result, MYSQLI_BOTH))
                    {
                        print "\n";
                        print "<tr><td>$row[Drug_name] </td><td> $row[Dosage]  </td></tr>    ";
                    }
                    print "</table>";
                    print "</pre>";
